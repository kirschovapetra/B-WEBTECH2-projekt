...
<html lang="sk">
    ...
    <body>
        ...
        <div class="d-flex justify-content-center">
            <a href="exportToCSV.php?lang=sk"><input type="submit" class="btn btn-primary" name="exportCSV" id="exportCSV" value="Export logov do CSV"></a>
            <a href="exportToPDF.php?lang=sk"> <input type="submit" class="btn btn-primary" name="exportPDF" id="exportPDF" value="Export logov do PDF"></a>
        </div>
