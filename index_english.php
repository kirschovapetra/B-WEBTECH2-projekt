    ...
    <body>
        ...
        <div class="d-flex justify-content-center mt-3 mb-5">
            <p>All types of the animations have their own type what helps us determine which animation do we want to run.
                <br>
                These commands run once we change the starting number. If we open Inspect in our browser the logs from <br> the commands can be found under the Console tab.
                <br>
                ...
                Difference between the commands is the part after type=. In case of the balls you can see on the example <br> it is set to ballbeam, in case of pendulum it will be pendulum and in case of the car it will be set to car.<br> The number we entered to the field is saved in the position, now we set it to 20 so position=0.2.
                <br>
                <i>Plane:</i><br>
                <b>octave/api/animation?type=plane&position=-0.2&newInput=[0,0,0]&apiKey=Strong12Key</b><br>
                The plane is a little bit different since we wanted to have positive numbers when the plane is taking off <br> and negative numbers when going down so we needed to change them up, <br>that is why the 20 we filled into the field is set to -0.2 in the command.
                <br><br>
        ...
        <div class="d-flex justify-content-center mt-3 mb-5">
            <a href="export/nikaExportEN.php"> <input type="submit" class="btn btn-primary" name="exportNikaEN" id="exportNikaEN" value="Export information to PDF"></a>
        </div>
